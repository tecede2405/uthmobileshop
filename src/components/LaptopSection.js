...
function LaptopSection() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/products/category/laptop`)
      .then((res) => res.json())
      .then((data) => setProducts(data))
      .catch((err) => console.error("Lỗi khi tải laptop:", err));
  }, [API_URL]);
  ...
  return (
    <>
    <img
        src="https://cdnv2.tgdd.vn/mwg-static/tgdd/Banner/73/06/7306f94c190e8ed5ce95caf5e5aa69e4.png"
        alt="Banner"
        className="product-banner-image"
      />
    <div className="products mt-3">
      <h2 className="mt-1 mb-1">Laptop</h2>
